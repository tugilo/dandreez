...
@section('content_header')
    <h1>
        <i class="fas fa-building"></i> 施工会社一覧
    </h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">登録済み施工会社</h3>
            <div class="card-tools">
                <a href="{{ route('construction_companies.create') }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> 新規施工会社追加
                </a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="construction-companies-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($constructionCompanies as $company)
                            <tr>
                                <td>
                                    <a href="{{ route('construction_companies.edit', $company->id) }}" class="btn btn-info btn-sm btn-icon">
...
@section('css')
    ...
    <style>
        #construction-companies-table th, #construction-companies-table td {
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#construction-companies-table').DataTable({
                language: {
