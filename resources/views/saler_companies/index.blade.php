...
@section('title', '問屋会社一覧')

@section('content_header')
    <h1>
        <i class="fas fa-building"></i> 問屋会社一覧
    </h1>
@stop
...
@section('content')
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">登録済み問屋会社</h3>
            <div class="card-tools">
                <a href="{{ route('saler_companies.create') }}" class="btn btn-primary btn-sm">
                    <i class="fas fa-plus"></i> 新規問屋会社追加
                </a>
        ...
        <div class="card-body">
            <div class="table-responsive">
                <table class="table table-bordered table-striped" id="saler-companies-table">
                    <thead>
                        <tr>
                    ...
                    <tbody>
                        @foreach ($salerCompanies as $company)
                            <tr>
                                <td>
                                    <a href="{{ route('saler_companies.edit', $company->id) }}" class="btn btn-info btn-sm btn-icon">
                                ...
                                <td>
                                    <form action="{{ route('saler_companies.destroy', $company->id) }}" method="POST" style="display: inline;">
                                        @csrf
                                        @method('DELETE')
...
@section('css')
    ...
    <style>
        #saler-companies-table th, #saler-companies-table td {
...
@section('js')
    ...
    <script>
        $(document).ready(function() {
            $('#saler-companies-table').DataTable({
                language: {
